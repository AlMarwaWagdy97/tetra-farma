                            ...
                            <div id="collapseLang{{ $key }}" class="accordion-collapse collapse show" data-bs-parent="#accordionLang{{ $key }}">
                                <div class="accordion-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="description{{ $key }}" name="{{ $locale }}[description]" class="form-control" rows="6">{{ old($locale . '.description') }}</textarea>
                                    </div>
...
{{-- 
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="{{ $locale }}[seo_title]" class="form-control" value="{{ old($locale . '.seo_title') }}">
                                    </div> --}}
                                    {{-- <div class="mb-3">
                                        <label class="form-label">SEO Description</label>
                                        <textarea name="{{ $locale }}[seo_description]" class="form-control" rows="2">{{ old($locale . '.seo_description') }}</textarea>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="employment_type" class="form-control" value="{{ old('employment_type') }}">
                        </div>
