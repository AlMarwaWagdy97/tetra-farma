                                                ...
                                                <div class="accordion-item border rounded">
                                                    ...
                                                    <div id="collapseOne{{ $key }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="example-text-input"
                                                                       class="col-sm-2 col-form-label">{{ trans('products.slug') .  trans('lang.' .Locale::getDisplayName(@$locale)) }}</label>
                                                                <div class="col-sm-10">
...
{{--                                                                                                                                        > {{ $trans->description ??   old($locale . '.description') }} </textarea>--}}
                                                        ...
                                                        @if( $trans )
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                                                                                    ...
                                                                                                                                    > {{ $trans->meta_desc ??  old($locale . '.meta_desc') }} </textarea>
                                                                    {{--                                                                    {!! $trans->meta_desc !!}--}}
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="{{ $locale }}[meta_key]"
                                                                              class="form-control description"
                                                                    > {{$trans->meta_key ??  old($locale . '.meta_key')  }} </textarea>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="feature"
                                                                   ...
                                                                   {{ $category->feature == 1 ? 'checked' : '' }} value="1">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input class="form-check form-switch" name="annual_occasion"
                                                                   ...
                                                                   {{ old('annual_occasion', $category->annual_occasion ?? 0) == 1 ? 'checked' : '' }}>
                                                     ...
                                                     <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input class="form-check form-switch" name="show_in_bottom"
                                                                   ...
                                                                   {{ old('show_in_bottom', $category->show_in_bottom ?? 0) == 1 ? 'checked' : '' }}>
                                                                   <label class="form-label" for="switch6"
                                                                   data-on-label=" @lang('admin.yes') "
                                                                   data-off-label=" @lang('admin.no')"></label>
                                                        </div>
                                                    </div>
